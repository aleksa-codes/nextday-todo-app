          ...
          <Sheet open={isOpen} onOpenChange={setIsOpen}>
            ...
            <SheetContent side='right' className='flex w-[280px] flex-col p-0 sm:w-[320px]'>
              ...
              <div className='flex-1 overflow-auto py-2'>
                ...
                {session && (
                  <Accordion type='single' collapsible className='mt-4 px-3'>
                          ...
                          <div className='space-y-1'>
                            {themeOptions.map((option) => (
                              <button
                                ...
                                onClick={() => setTheme(option.value)}
                                className={cn(
                                  'text-muted-foreground hover:bg-muted hover:text-foreground flex w-full items-center gap-3 rounded-md py-1.5',
